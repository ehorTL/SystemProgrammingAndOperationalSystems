...
public class ls {
    ...
    private static void print(String name, Stat stat) {
        ...
        type = (short) stat.getMode();//выводим
        //конвертирует type в восьмиричное предствление
        //права изера
        //права группы
        //права других (не изер главный и не юзер группы)
        s.append(Integer.toOctalString((type & Kernel.S_IRWXU) >> 6)); //сдвиг 111000000(это 0700)
        s.append(Integer.toOctalString((type & Kernel.S_IRWXG) >> 3));
        s.append(Integer.toOctalString(type & Kernel.S_IRWXO));

        // append the inode number in a field of 5(выравнивание)
        ...
        // append the size in a field of 10(выравнивание)
